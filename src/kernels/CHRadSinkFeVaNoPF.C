...
CHRadSinkFeVaNoPF::CHRadSinkFeVaNoPF(const InputParameters & parameters) :
   Kernel(parameters),
...
Real
CHRadSinkFeVaNoPF::computeQpResidual()
{
...
Real
CHRadSinkFeVaNoPF::computeQpJacobian()
{
  Real tol = _LogTol[_qp];
  RealGradient outval1 = 0.0;
  Real ytot = _u[_qp];
