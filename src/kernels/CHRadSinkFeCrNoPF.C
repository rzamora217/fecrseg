...
CHRadSinkFeCrNoPF::CHRadSinkFeCrNoPF(const InputParameters & parameters) :
   Kernel(parameters),
...
Real
CHRadSinkFeCrNoPF::computeQpResidual()
{
...
Real
CHRadSinkFeCrNoPF::computeQpJacobian()
{
  Real tol = _LogTol[_qp];
  RealGradient outval1 = 0.0;
  Real ytot = _u[_qp];
